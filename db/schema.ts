...
export const medicines = sqliteTable('medicines', {
  ...
  marketingAuthorisationDeveloper: text('marketing_authorisation_developer_applicant_holder'),
  ...
  refusalMarketingAuthorisationDate: text('refusal_of_marketing_authorisation_date'),
  withdrawalExpiryRevocationDate: text(
    'withdrawal_expiry_revocation_lapse_of_marketing_authorisation_date',
  ),
  suspensionMarketingAuthorisationDate: text('suspension_of_marketing_authorisation_date'),
